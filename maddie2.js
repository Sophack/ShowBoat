...
function resultsPage() {
    ...
    for (i = 0; i < 4; i++) {
        ...
        console.log(i); 
        //the above function works but it populates random things 
        //the for loop didnt work 
        //
        

        // //getting the src for the attribute & checking if nothing is inside of it
        // then set the attribute then the value should be the info there
        //preventing from going on more than once
...
resultsPage(); // when the results page loads, the for loop (line 75 should pop out) 